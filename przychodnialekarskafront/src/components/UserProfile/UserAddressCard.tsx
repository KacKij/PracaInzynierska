...
export default function UserAddressCard() {
  ...
  const { userAddress, fetchUserAddress } = useAuth();
  ...
  useEffect(() => {
    if (userAddress) {
      ...
      setStreetNumber(userAddress.streetNumber);
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-7 2xl:gap-x-32">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                  {userAddress?.zipCode || "Not provided"}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                  {userAddress?.street || "Not provided"}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                  {userAddress?.streetNumber || "Not provided"}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                  {userAddress?.apartmentNumber || "Not provided"}
                </p>
              </div>
